        ...
        if (jsonResponse != null && jsonResponse['status'] == 'OK') {
          ...
          if (routes != null && routes.isNotEmpty) {
            ...
            if (legs != null && legs.isNotEmpty) {
              ...
              if(duration != null){
                DataCubit.get(context).timeChange(Duration(seconds: duration).inMinutes);
              }
  ...
  Future handle(BuildContext context) async {
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async{
      ...
      if (message.data['message'] == 'Send Request Trip less Price') {
        ...
        setState(() {
          drivingState = true;
          DataCubit.tripToPickup = true;
          setState(() {
            DataCubit.loadingState = false;
            _markers.add(Marker(
        ...
        if (tripModel.pickupLongitude == null ||
          ...
          getEstimatedTime(
              ...
              .then((value) async {
            if(value != null){ DataCubit.time = value;}
            ...
            child: Column(
              ...
              children: [
                ...
                MainElevatedButtonTwo(
                  condition:state is StartTripLoadingState || state is GetInProgressTripDetailsLoadingState ,
                    onPressed: () async {
    ...
    _positionStreamSubscription = locationStream!.listen((Position position) {
      if (_previousPosition != null &&
        ...
        setState(() {
          ...
          if(DataCubit.tripToPickup == true || tripToDestination == true){_checkProximity(context);}
        });
      } else {
        _previousPosition = position;
      }
        ...
        return SafeArea(
          child: Stack(
            children: [
              ...
              DataCubit.tripToPickup == true && tripModel.pickupLatitude != null
                  ? Positioned(
                      bottom: 120,
                      right: 10,
                      child: FloatingActionButton(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                            ...
                            InkWell(
                              onTap: () {
                                if (driverData != null &&
                                  ...
                                  if(drivingState == true){
                                    Fluttertoast.showToast(
                                        msg:
                                        'You are already in trip',
                                        fontSize: 18.dp,
                    ...
                    const Spacer(),
                    DataCubit.tripToPickup == true && DataCubit.inRange == true
                        ? SizedBox(
                            width: 40.w,
                            child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                        ...
                        : DataCubit.tripToPickup == false && tripToDestination == true
                            ? SizedBox(
                                width: 40.w,
                                child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
