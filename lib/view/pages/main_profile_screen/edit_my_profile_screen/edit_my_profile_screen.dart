              ...
              child: Column(
                children: [
                  ...
                  MainElevatedButtonTwo(
                    ...
                    onPressed: () {
                      LoginCubit.get(context).editUser(
...
class DriverLicenseScreenInEditMyProfile extends StatefulWidget {
  ...
  @override
  State<DriverLicenseScreenInEditMyProfile> createState() =>
      _DriverLicenseScreenInEditMyProfileState();
}

class _DriverLicenseScreenInEditMyProfileState
    extends State<DriverLicenseScreenInEditMyProfile> {
  Future<void> selectDate() async {
    DateTime? picked = await showDatePicker(
        context: context,
  ...
  @override
  void initState() {
    if (loginData.driverLicense != null &&
        loginData.driverLicense![0].licenseNumber != null) {
      driverLicenseController.text = loginData.driverLicense![0].licenseNumber!;
    }
    if (loginData.driverLicense != null &&
        loginData.driverLicense![0].licenseExpiry != null) {
    ...
    return BlocConsumer<LoginCubit, LoginState>(
      listener: (context, state) {
        if (state is EditDriverLicenseSuccessState) {
          ...
          loginData.driverLicense![0].licenseNumber =
                  ...
                  children: [
                      ...
                      child: DottedBorder(
                        ...
                        child: Container(
                          ...
                          child: LoginCubit.frontLicenseImage != null
                              ...
                              : loginData.driverLicense != null && loginData.driverLicense![0].licenseFrontImage !=
                                      null
                                  ? Image.network(
                                      "${loginData.driverLicense![0].licenseFrontImage!}",
                                      height: 300,
                                      width: 300,
                                      fit: BoxFit.fill,
                                      errorBuilder:
                      ...
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                            style: OutlinedButton.styleFrom(
                                side:
                                    const BorderSide(color: Color(0xffFF6A03))),
                            onPressed: () {
                              LoginCubit.get(context)
                                  .pickImage(
                                      image: LoginCubit.frontLicenseImage)
                                  .then((value) {
                                setState(() {
                      ...
                      child: DottedBorder(
                        ...
                        child: Container(
                          ...
                          child: LoginCubit.backLicenseImage != null
                              ...
                              : loginData.driverLicense != null && loginData.driverLicense![0].licenseBackImage !=
                                      null
                                  ? Image.network(
                                      "${loginData.driverLicense![0].licenseBackImage!}",
                                      height: 300,
                                      width: 300,
                    ...
                    Center(
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                            ...
                            onPressed: () async {
                              LoginCubit.get(context)
                                  .pickImage(image: LoginCubit.backLicenseImage)
                                  .then((value) {
                                setState(() {
                    ...
                    Center(
                      child: MainElevatedButtonTwo(
                          ...
                          circularBorder: true,
                          onPressed: () {
                            LoginCubit.get(context).editDriverLicense(
...
class InsuranceScreenInEditMyProfile extends StatefulWidget {
  ...
  @override
  State<InsuranceScreenInEditMyProfile> createState() =>
      _InsuranceScreenInEditMyProfileState();
}

class _InsuranceScreenInEditMyProfileState
    extends State<InsuranceScreenInEditMyProfile> {
  TextEditingController expiryDateController = TextEditingController();
  TextEditingController driverLicenseController = TextEditingController();
  Future<void> selectDate() async {
    DateTime? picked = await showDatePicker(
  ...
  @override
  void initState() {
    if (loginData.driverInsurance != null &&
        loginData.driverInsurance!.insuranceExpiry != null) {
      expiryDateController.text = loginData.driverInsurance!.insuranceExpiry!;
    }
    if (loginData.driverInsurance != null &&
        loginData.driverInsurance!.insuranceNumber != null) {
      driverLicenseController.text =
          loginData.driverInsurance!.insuranceNumber!;
    }
    ...
    return BlocConsumer<LoginCubit, LoginState>(
      listener: (context, state) {
        if (state is EditInsuranceLicenseSuccessState) {
          loginData.driverInsurance!.insuranceExpiry =
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: SizedBox(
                        ...
                        child: OutlinedButton(
                            ...
                            onPressed: () async {
                              LoginCubit.get(context)
                                  .pickImage(image: LoginCubit.insuranceLicense)
                                  .then((value) {
                                setState(() {
                    ...
                    Center(
                      child: MainElevatedButtonTwo(
                          onPressed: () {
                            LoginCubit.get(context).editInsuranceLicense(
                                insuranceLicense: driverLicenseController.text,
                                insuranceExpiry: expiryDateController.text,
