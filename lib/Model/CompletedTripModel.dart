...
//
//   CompletedTripsModel({this.status, this.driverCompletedTrips});
//
//   CompletedTripsModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
...
//   String? actualPickupLatitude;
//   String? actualPickupLongitude;
